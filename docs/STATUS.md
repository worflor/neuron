...
| UI look & feel | 🟡 works, polishing | it's not ugly and it's not good — it just is, right now. everything's legible and does what it says, but the visual design hasn't had a real pass yet. |
